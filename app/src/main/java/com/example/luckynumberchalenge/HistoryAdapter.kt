...
class HistoryAdapter (val data: List<History>): RecyclerView.Adapter<HistoryAdapter.HistoryViewHolder>() {
    ...
    class HistoryViewHolder(val row: View): RecyclerView.ViewHolder(row){
